...
async def characters_handler(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    ...
    try:
        ...
        # Send character gallery first
        main_characters = ["alok", "chrono", "kelly", "hayato", "jota", "dimitri"]
        await fire_image_handler.send_character_gallery(update, context, main_characters)
...
async def fire_button_handler(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    ...
    try:
        ...
        # Send fire button setup image first
        await fire_image_handler.send_gameplay_guide_image(update, context, "fire_button_setup")
        ...
        # Send sensitivity guide image
        await asyncio.sleep(1)
        await fire_image_handler.send_gameplay_guide_image(update, context, "sensitivity_guide")
        ...
        # Send character combinations image
        await asyncio.sleep(1)
        await fire_image_handler.send_gameplay_guide_image(update, context, "character_combinations")
        ...
        # Send recoil patterns image
        await asyncio.sleep(1)
        await fire_image_handler.send_gameplay_guide_image(update, context, "recoil_patterns")
